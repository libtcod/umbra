...
${OBJECTDIR}/src/umbra/umbra_imod_credits.o: src/umbra/umbra_imod_credits.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/umbra
	${RM} $@.d
	$(COMPILE.cc) -g -I../libtcod/include -Isrc/umbra -Isrc/fov -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/umbra/umbra_imod_credits.o src/umbra/umbra_imod_credits.cpp
...
${OBJECTDIR}/src/demo/circle.o: src/demo/circle.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I../libtcod/include -Isrc/umbra -Isrc/fov -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/demo/circle.o src/demo/circle.cpp
